...
export function getDriverInfo(){
    ...
    //request.get("http://192.168.0.4:3000/api/driver/" + id)
    request.get("http://35.231.160.106:3000/api/driver/" + id)
		.finish((erroe, res)=>{
			dispatch({
...
export function getDriverLocation(){
	return (dispatch, store)=>{
		let id = store().home.booking.driverId;
		//request.get("http://24.28.21.64:3000/api/driverLocation/" + id)
    //request.get("http://192.168.0.4:3000/api/driverLocation/" + id)
    //request.get("http://localhost:3000/api/driverLocation/" + id)
    request.get("http://35.231.160.106:3000/api/driverLocation/" + id)
		.finish((erroe, res)=>{
			dispatch({
